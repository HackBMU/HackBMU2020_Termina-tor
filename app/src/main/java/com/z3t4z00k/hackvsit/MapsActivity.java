...
import com.z3t4z00k.hackvsit.netwrok.geocode.Location;
import com.z3t4z00k.hackvsit.netwrok.GeocodeResponse;
import com.z3t4z00k.hackvsit.netwrok.RetrofitInterface;
import com.z3t4z00k.hackvsit.onboarding.DefaultIntro;
import com.z3t4z00k.hackvsit.utils.UtilsCheck;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,OnConnectionFailedListener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        armap=findViewById(R.id.openar);
        ...
        adapter=new placesadapter(this,listurl);
    ...
    void Geocode_Call(String address){
        ...
        call.enqueue(new Callback<GeocodeResponse>() {
            ...
            public void onResponse(Call<GeocodeResponse> call, Response<GeocodeResponse> response) {
                ...
                List<com.z3t4z00k.hackvsit.netwrok.geocode.Result> results=response.body().getResults();
...
//        });
    ...
    public void indoorNav(View view) {
        Intent intent = getPackageManager().getLaunchIntentForPackage("com.ustglobal.arcloudanchors");
        startActivity(intent);

    }

    public void v360(View view) {
        Intent intent = getPackageManager().getLaunchIntentForPackage("com.z3t4z00k.v360");
        startActivity(intent);
    }
